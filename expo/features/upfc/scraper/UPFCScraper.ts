...
export default class UPFCScraper implements Scraper {
  ...
  parseEventApplications(eventsHtml: string, execEventHtml: string, ticketsHtml: string): EventApplicationTickets[] {
  ...
  parseTicketsHtml(text: string): EventApplicationTickets[] {
    ...
    const allApplications: EventApplicationTickets[] = [];
  ...
  private parseEventDate(dateStr: string, timeStr: string): EventDateTime | null {
