import ErrorBoundary, { FallbackComponent } from '@hpapp/features/common/components/ErrorBoundary';
import { servicerootQuery } from '@hpapp/features/root/internals/protected/context/__generated__/servicerootQuery.graphql';
import {
  HelloProject,
  useHelloprojectFragment,
  HPArtist,
  HPMember
} from '@hpapp/features/root/internals/protected/context/helloproject';
import { useMeFragment, Me } from '@hpapp/features/root/internals/protected/context/me';
