...
const (
	// Label holds the string label denoting the hpmember type in the database.
	Label = "hp_member"
	...
	FieldName = "name"
	// FieldNameKana holds the string denoting the name_kana field in the database.
	FieldNameKana = "name_kana"
	...
	ArtistColumn = "hp_artist_members"
	...
	TaggedElineupMallItemsTable = "hp_member_elineup_mall_items"
	...
	FollowedByColumn = "hp_follow_member"
)

// Columns holds all SQL columns for hpmember fields.
var Columns = []string{
	FieldID,
	FieldCrawledAt,
	FieldErrorCount,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "hp_members"
...
var (
	...
	AssetsPrimaryKey = []string{"hp_member_id", "hp_asset_id"}
	...
	TaggedFeedPrimaryKey = []string{"hp_member_id", "hp_feed_item_id"}
	...
	TaggedIgPostsPrimaryKey = []string{"hp_member_id", "hp_ig_post_id"}
	...
	TaggedAmebloPostsPrimaryKey = []string{"hp_member_id", "hp_ameblo_post_id"}
	...
	TaggedElineupMallItemsPrimaryKey = []string{"hp_member_id", "hp_elineup_mall_item_id"}
)
...
// ByNameKana orders the results by the name_kana field.
func ByNameKana(opts ...sql.OrderTermOption) Order {
	return sql.OrderByField(FieldNameKana, opts...).ToFunc()
}
...
func ByArtistID(opts ...sql.OrderTermOption) Order {
