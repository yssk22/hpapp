...
type MetricQuery struct {
	...
	loadTotal  []func(context.Context, []*Metric) error
...
func (mq *MetricQuery) Order(o ...metric.Order) *MetricQuery {
	mq.order = append(mq.order, o...)
	return mq
}

// QueryUser chains the current query on the "user" edge.
func (mq *MetricQuery) QueryUser() *UserQuery {
...
func (mq *MetricQuery) Clone() *MetricQuery {
	...
	return &MetricQuery{
		config:     mq.config,
		ctx:        mq.ctx.Clone(),
		order:      append([]metric.Order{}, mq.order...),
...
func (mq *MetricQuery) WithUser(opts ...func(*UserQuery)) *MetricQuery {
	query := (&UserClient{config: mq.config}).Query()
...
func (mq *MetricQuery) prepareQuery(ctx context.Context) error {
	...
	if metric.Policy == nil {
		return errors.New("ent: uninitialized metric.Policy (forgotten import ent/runtime?)")
	}
	if err := metric.Policy.EvalQuery(ctx, mq); err != nil {
		return err
	}
	return nil
}
...
func (mq *MetricQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Metric, error) {
	...
	if query := mq.withUser; query != nil {
		if err := mq.loadUser(ctx, query, nodes, nil,
			func(n *Metric, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
...
func (mq *MetricQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Metric, init func(*Metric), assign func(*Metric, *User)) error {
...
func (mq *MetricQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := mq.ctx.Fields; len(fields) > 0 {
		...
		if mq.withUser != nil {
			_spec.Node.AddColumnOnce(metric.FieldOwnerUserID)
		}
	}
